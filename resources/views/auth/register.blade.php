            ...
            <div class="max-w-md w-full p-6">
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mb-4 text-lg text-center">
                        <select id="section" name="section" value="{{ old('section') }}" class="mt-1 p-2 w-full border rounded-md focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300"
                    ...
                    <button type="submit" class="w-full bg-black text-white p-2 rounded-md hover:bg-gray-800 focus:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors duration-300">Register</button>
