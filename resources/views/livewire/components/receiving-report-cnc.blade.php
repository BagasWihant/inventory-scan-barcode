<div>
    <div class="grid md:grid-cols-8 gap-3 w-full pb-6">
        ...
        <div class="col-span-2">
            ...
            <input wire:model="searchPalet" wire:keydown.debounce.300ms="paletChange" type="text" autocomplete="off"  @if ($inputDisable) disabled @endif
            ...
            <div class="">
                ...
                <div wire:loading.remove class="rounded-lg bg-slate-50 shadow absolute">
                    ...
                    @if (strlen($searchPalet) >= 3 && $listPalet != 'kosong')
