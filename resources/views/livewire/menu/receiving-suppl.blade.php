<div>
    <div class="flex gap-4">
        ...
        <div class="flex flex-col w-1/4">
            ...
            <input wire:model.live="surat_jalan" type="text" @if ($suratJalanDisabel) disabled @endif
                id="surat_jalan"
                class="@if ($suratJalanDisabel) bg-gray-100 @endif w-full p-2 text-gray-900 border border-gray-300 rounded-lg text-base focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
