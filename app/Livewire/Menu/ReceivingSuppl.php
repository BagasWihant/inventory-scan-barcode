...
class ReceivingSuppl extends Component
{
    use WithPagination;
    ...
    public $suratJalanDisabel = false, $paletDisable = false, $poDisable = false;
    ...
    public function choosePo($po = null)
    {
        if ($this->surat_jalan !== null) {
            ...
            DB::beginTransaction();
            $productsQuery->chunk(100, function ($products) {
    ...
    public function materialNoScan()
    {
        ...
        if ($supplierCode) {
            ...
            $this->dispatch('alert', ['title' => 'Warning', 'time' => 3500, 'icon' => 'warning', 'text' => 'Material number not found in Conversion List']);
        }
        $this->material_no = null;
    }
