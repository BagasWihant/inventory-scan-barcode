    ...
    public function submitRequest($data)
    {
            foreach ($data as $value) {
                MaterialRequestAssy::create([
                    ...
                    'type' => '-',
                    'request_qty' => (int) $value['request_qty'], // kadang nek hasil e koma error soale ng db int jaluk e, tak pekso int
                    ...
                    'sisa_request_qty' => $value['qty'] - (int) $value['request_qty'] // iki yo tak pekso int soale kadang eror nek koma
                ]);
            }
            ...
            return [
                'success' => true,
                'message' => 'Berhasil Request Material Assy'
            ];
